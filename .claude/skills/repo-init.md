---
description: Bootstrap a complete Claude/Windsurf-ready repository with apps/, docs/, .claude/, and structured backlog
---

# Windsurf Repo Bootstrapper (Full LLM + Backlog Starters)

## 🧭 Overview

This script sets up a complete Claude/Windsurf-ready repository with:

- Git initialization
- Generic apps/ layout (ui, api, agent)
- .claude/ folder for prompts, memory, and context
- Documentation scaffolding (docs/knowledge, docs/research, etc.)
- A structured backlog hierarchy with starter templates for epics, stories, and tasks

## 🧩 Run This in Windsurf (Claude Code Terminal)
...
│   │   ├── structure.md
│   │   ├── epics/
│   │   │   └── EP-000-foundational-setup.md
│   │   ├── stories/
│   │   │   └── ST-000-initialize-repo-scaffold.md
│   │   └── tasks/
│   │       └── TK-000-bootstrap-script.md
│   ├── knowledge/
│   ├── research/
│   └── prompts/
│       └── init.md
...
- **docs/** - Documentation root
  ...
  - **backlog/** - Structured work items (epics/stories/tasks)
  - **prompts/** - Reusable AI prompts
- **.claude/system/** - Claude context and prompts
...
- **README.md** - Project documentation (empty template)
- **.github/ABOUT.md** - Repository description
...
- **docs/backlog/structure.md** - Backlog conventions
...
1. Edit `OBJECTIVE.md` with your project goals
2. Update `.claude/system/system_prompt.md` for your coding style
3. Add epics to `docs/backlog/epics/`
4. Populate `docs/knowledge/` with domain knowledge

## 🚀 Benefits

✅ **Instant Structure** - Complete scaffold in seconds
✅ **AI-Optimized** - Pre-configured for Claude Code/Windsurf
✅ **Backlog Ready** - Starter templates for planning
✅ **Idempotent** - Safe to re-run
✅ **Generic** - Works for any project type
✅ **Documented** - Built-in conventions and guides
